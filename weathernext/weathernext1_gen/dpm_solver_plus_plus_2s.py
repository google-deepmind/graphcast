...
from weathernext.weathernext1_gen import denoisers_base
from weathernext.weathernext1_gen import samplers_base as base
from weathernext.weathernext1_gen import samplers_utils as utils
import haiku as hk
...
class Sampler(base.Sampler):
  ...
  def __call__(
    ...
    def body_fn(i: jnp.ndarray, x: xarray.Dataset) -> xarray.Dataset:
      ...
      x_denoised = denoiser(noise_level, x)  # pyrefly: ignore[bad-argument-type]
