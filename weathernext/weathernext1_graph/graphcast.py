...
FORCING_VARS = variables.EXTERNAL_FORCING_VARS + variables.TIME_FORCING_VARS


TaskConfig = task_base.TaskConfig
...
TASK = TaskConfig(
    ...
    pressure_levels=variables.PRESSURE_LEVELS_ERA5_37,
    input_duration="12h",
)
TASK_13 = TaskConfig(
    input_variables=(
  ...
  * Mesh2Grid graph: Graph that contains all nodes. This graph is strictly
  ...
  def __init__(self, model_config: ModelConfig, task_config: TaskConfig):
    ...
    num_surface_vars = len(
        set(task_config.target_variables) - set(variables.ALL_ATMOSPHERIC_VARS))
